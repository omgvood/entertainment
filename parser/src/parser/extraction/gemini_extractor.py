...
_SYSTEM_PROMPT_SINGLE = f"""Ты — экстрактор данных о развлекательных событиях в Перми. На вход — HTML страницы события. На выход — JSON по предоставленной схеме.
...
_SYSTEM_PROMPT_BATCH = f"""Ты — экстрактор данных о развлекательных событиях в Перми. На вход — HTML страницы СО СПИСКОМ событий (расписание, афиша). На выход — JSON-массив со ВСЕМИ событиями, которые упомянуты на странице.
