...
| Туманная задача, много связанных проблем | `mattpocock-skills:wayfinder` → сведение (3–7 проблем, одна волна) → дальше по строке выше | `docs/superpowers/wayfinder/<эффорт>/map.md` + `issues/` |
