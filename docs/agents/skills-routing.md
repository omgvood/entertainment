...
Любой путь, названный в этом файле или в `CLAUDE.md`, обязан существовать на диске: `CLAUDE.md` месяцами ссылался на `.scratch/`, которого никогда не было, и расхождение было молчаливым.
